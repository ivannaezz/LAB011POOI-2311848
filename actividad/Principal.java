...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        AuthorMetodos authorMetodos = new AuthorMetodos();
        BookMetodos bookMetodos = new BookMetodos();
        ...
        switch (numOperacion) {
            ...
            case 2:
                ...
                if (!authorMetodos.emailValido(emailAutor)) {
                    ...
                    if (autor == null) {
                        ...
                        autor = new Author(nombreAutor, emailAutor, generoAutor);
                        authorMetodos.adicionar(autor);
                    }
                }    
                
                Book book = new Book(nombreLibro, autor, precio, cantidad);
            ...
            case 3:
                ...
                Book libroEliminar = bookMetodos.buscarLibro(nombreLibroEliminar);
            ...
            case 4:
                ...
                Book libroAEditar = bookMetodos.buscarLibro(nombreLibroEditar);
            ...
            case 5:
                ...
                Book libroEncontrado = bookMetodos.buscarLibro(tituloBuscar);
            ...
            case 6:
                ...
                Author autorEncontrado = bookMetodos.buscarAutorPorLibro(tituloLibroBusqueda);
